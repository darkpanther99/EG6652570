...
\begin{itemize}
	...
	\item Metódusok:
	\begin{itemize}
		\item void Chill(Tile t): Mivel a játékos nincsen vízben ezért nem kell csökkenteni a testhőjét.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Metódusok
	\begin{itemize}
		\item void GiveTo(Player p): A játékost nem ruházza fel extra tulajdonsággal.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Metódusok:
	\begin{itemize}
	\item void BuildIgloo(): Épít egy iglut a mezőre, amin áll. Az iglu megvéd majd a hóvihartól.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Metódusok:
	\begin{itemize}
		\item void Chill(Tile t): A cellán álló játákosok testhője nem csökken.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Metódusok:
	\begin{itemize}
		\item void GiveTo(p: Player): A jétékos kap valamilyen tárgyat.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item inventory: Item[*]: Tárolja a játékos tárgyait.
...
\begin{itemize}
	...
	\item Metódusok
	\begin{itemize}
		\item void GiveTo(Player p): A játékos kap egy kötelet.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Metódusok:
	\begin{itemize}
		\item void Chill(p: Player): A játékost nem hűti a víz.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Metódusok:
	\begin{itemize}
		\item void GiveTo(): A játékos ásót kap.
	\end{itemize}
\end{itemize}
