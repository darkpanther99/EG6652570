...
"%JAVA_HOME%\bin\javac.exe" -encoding UTF-8 -d %classfolder% %src%\grafikus\*.java %src%\grafikus\model\*.java %src%\grafikus\maploader\*.java %src%\grafikus\mapgen\*.java
xcopy %res%\* %classfolder% /s /i /q > nul
