...
public class BareIce extends Shelter {
     ...
     *
     * @param t A Tile típusú jégtábla objektum, amin a menedék(jelen esetben a semmi) található, és a rajta lévő entitások fáznak rajta.
     */
     ...
     *
     * @param t A Tile típusú jégtábla objektum, amin a menedék(jelen esetben a semmi) található, és a rajta lévő entitások medvetámadás áldozatai lettek.
     */
