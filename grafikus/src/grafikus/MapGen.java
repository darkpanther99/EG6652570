...
public final class MapGen {
    ...
    /**
     * Az osztály csak statikus tagokkal rendelkezik.
     */
    private MapGen() {
    }
    ...
    private static boolean generateTiles() {
        ...
        for (int i = 0; i <= cols * rows - 1; i++) {
            game.createTile(random.nextInt(5 + 1), random.nextInt(game.getPlayers().size() + 1 + 1) - 1);
            //game.createTile(0,1);
        }
    ...
    /**
     * Pálya összerakása.
     * @param g Az eredmény ide kerül.
     * @param r Négyzetrács sorai.
     * @param c Négyzetrács oszlopai.
     */
